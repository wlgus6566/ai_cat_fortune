...
const validateName = (name: string): { isValid: boolean; errorMessage: string } => {
  ...
  if (koreanSingleCharRegex.test(name)) {
    return { isValid: false, errorMessage: 'nameValidation.incompleteCharacter' };
  }
      ...
      <div className="p-4">
        ...
        <form className="space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div className="bg-purple-50 p-5 rounded-lg">
              <label className="block text-sm font-medium text-purple-800 mb-3">
                <span className="text-purple-600 mr-1">☀</span> {t('calendarType')}
              </label>
              <div className="flex space-x-4">
                <label className="inline-flex items-center p-3 bg-white rounded-lg border border-purple-200 cursor-pointer hover:bg-purple-100 transition-colors">
                  <input
          ...
          <div className="bg-purple-50 p-5 rounded-lg">
            <label className="block text-sm font-medium text-purple-800 mb-3">
              <span className="text-purple-600 mr-1">🌟</span> {t('birthDate')}
            </label>
            {!showDatePicker ? (
              ...
              <div className="space-y-4 p-4 border border-purple-200 rounded-lg bg-white shadow-sm">
                <div className="grid grid-cols-3 gap-3">
                  <div>
                    <label className="block text-xs text-purple-600 mb-1 font-medium">년</label>
                    <select
                      value={birthYear}
                  ...
                  <div>
                    <label className="block text-xs text-purple-600 mb-1 font-medium">월</label>
                    <select
                      value={birthMonth}
                  ...
                  <div>
                    <label className="block text-xs text-purple-600 mb-1 font-medium">일</label>
                    <select
                      value={birthDay}
          ...
          <div className="bg-purple-50 p-5 rounded-lg">
            <label htmlFor="birthTime" className="block text-sm font-medium text-purple-800 mb-3">
              <span className="text-purple-600 mr-1">🕐</span> {t('birthTime')}
            </label>
            <select
              id="birthTime"
              value={birthTime}
          ...
          <div className="flex justify-center space-x-4 pt-6 mt-6 border-t border-purple-100">
            <button
              type="button"
              onClick={handleCancel}
              className="px-8 py-3 border border-purple-300 rounded-lg text-purple-800 hover:bg-purple-50 transition-colors shadow-sm"
            >
              {t('cancel')}
            </button>
            <button
              ...
              onClick={handleSave}
              disabled={isSaving}
              className={`px-8 py-3 rounded-lg shadow-md transform hover:-translate-y-1 transition-all ${
                isSaving 
